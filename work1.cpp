...
auto Work1::doWork2() -> Result
{
    ...
    if(!gcodes.isEmpty()){
        ...
        QTime tm(0,0);
        tm = tm.addSecs(g._totalStats._total_minutes*60);//mm per perc
        QStringList outLines({
            ...
            L("(total cut: ")+QString::number(g._totalStats._total_cut)+"mm)",
            L("(total length: ")+QString::number(g._totalStats._total_length)+"mm)"
        });
